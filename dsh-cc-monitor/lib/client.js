window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const zh = {
      ...
      "serverUrl": "服务器 URL",
      "serverUrlHint": "cc-monitor 服务器的完整地址，例如 https://192.168.1.100:9876；留空则使用下方的主机和端口。",
      "parse": "解析",
      "host": "主机",
    ...
    const en = {
      ...
      "serverUrlHint": "Full cc-monitor base URL, e.g. https://192.168.1.100:9876; leave blank to use the host and port below.",
      "parse": "Parse",
      "host": "Host",
